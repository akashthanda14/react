      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="rounded-2xl border border-white/10 bg-zinc-900/50 p-8 shadow-2xl backdrop-blur-xl">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white mb-1">Welcome to akashcodeofficial</h1>
            <p className="text-zinc-400 text-sm mb-4">Master System Design & Ace Your Interviews</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full rounded-lg border border-zinc-700 bg-zinc-900 py-3 pl-10 pr-3 text-white placeholder-zinc-500 transition-all focus:border-neon/50 focus:outline-none focus:ring-2 focus:ring-neon/20 disabled:opacity-50"
                />
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 rounded-lg border border-zinc-700 bg-zinc-900 py-3 font-medium text-white transition-all hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-zinc-600 disabled:opacity-50 disabled:cursor-not-allowed"
            >
